    ...
    var body: some View {
        GeometryReader { gRR in
            ZStack (alignment: .top){
                fieldImage(idx: currentImageIndex)//.border(Color.green)
                fieldAnnotation(idx: currentImageIndex)//.border(Color.pink)
                drawRunway(idx: currentImageIndex, width: Double(gRR.size.width), height: Double(gRR.size.width)/2).foregroundColor(.yellow)//.border(Color.purple)
                drawPOIs(idx: currentImageIndex, width: Double(gRR.size.width), height: Double(gRR.size.width)/2).foregroundColor(.yellow)//.border(Color.black)
                ...
                bezPath(idx: currentImageIndex, xd: self.tel.currentXd, yd: self.tel.currentYd, width: Double(gRR.size.width), height: Double(gRR.size.width / 2)).foregroundColor(.yellow)//.border(Color.yellow)
